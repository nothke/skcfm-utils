...
# curl -X GET -u ProppFrexx:slavoljub -d 'MIXER_INPUT_VOLUME_GET MIC1' http://localhost:8081/commands

# curl -u ProppFrexx:slavoljub -d "SHOW_ALERT_WINDOW Hello|Oh no!" http://localhost:8081/commands
# curl -u ProppFrexx:slavoljub -d "PLS_CURRENT_APPEND_FILE wrong_file" http://localhost:8081/commands
# curl -u ProppFrexx:slavoljub -d "PLS_CURRENT_PLAY_NEXT" http://localhost:8081/commands
